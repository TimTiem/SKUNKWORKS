...
const VARIANTS = {
  ...
  primary:
    'rounded-control bg-accent-strong px-4 py-3 text-sm font-bold uppercase tracking-wider text-accent-ink transition-colors duration-enter ease-standard hover:bg-accent-base disabled:opacity-60',
